type qubits_m = (((((((((((qubit & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit)<M>
type qubits_p = (((((((((((qubit & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit)<P>

type all = (qubit & (((((((((((qubit & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit))<P>
...
fun mult (cqs : all) : all =
    ...
    let (((((((((((q1 : qm, q2 : qm), q3 : qm), q4 : qm), q5 : qm), q6 : qm), q7 : qm), q8 : qm), q9 : qm), q10 : qm), q11 : qm), q12 : qm) = qs in
    ...
    let (c : qm, (q1 : qm, q12 : qm)) = FRED (c, (q1, q12)) in
    let res : all = (c, (((((((((((q1, q2), q3), q4), q5), q6), q7), q8), q9), q10), q11), q12)) in
    res
...
fun invert (cqs : all) : all =
    ...
    let (c : qm, (q1 : qm, q2 : qm)) = FRED (c, (q1, q2)) in
    let (c : qm, (q2 : qm, q3 : qm)) = FRED (c, (q2, q3)) in
    let (c : qm, (q3 : qm, q5 : qm)) = FRED (c, (q3, q5)) in (* THIS IS WRONG *)
    let (c : qm, (q4 : qm, q5 : qm)) = FRED (c, (q4, q5)) in
    let (c : qm, (q5 : qm, q6 : qm)) = FRED (c, (q5, q6)) in
    let (c : qm, (q6 : qm, q7 : qm)) = FRED (c, (q6, q7)) in
    let (c : qm, (q7 : qm, q8 : qm)) = FRED (c, (q7, q8)) in
...
fun main () : (qp * qubits_p) =
  let c = o () in
  let num : qubits_p = ((((((((((((o ()), z ()), z ()), o ()), o ()), z ()), z ()), o ()), z ()), z ()), z ()), z ()) in
