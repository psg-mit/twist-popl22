type qubits_m = ((((((((qubit & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit)<M>
type qubits_p = ((((((((qubit & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit)<P>

type all = (qubit & ((((((((qubit & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit) & qubit))<P>
...
fun mult (cqs : all) : all =
    ...
    let ((((((((q1 : qm, q2 : qm), q3 : qm), q4 : qm), q5 : qm), q6 : qm), q7 : qm), q8 : qm), q9 : qm) = qs in
    ...
    let (c : qm, (q1 : qm, q9 : qm)) = FRED (c, (q1, q9)) in
    let res : all = (c, ((((((((q1, q2), q3), q4), q5), q6), q7), q8), q9)) in
    res
...
fun main () : (qp * qubits_p) =
  let c = o () in
  let num : qubits_p = (((((((((o ()), z ()), z ()), o ()), o ()), z ()), z ()), o ()), z ()) in
