...
let speclist =
  ...
  ; "-ignore_static", Arg.Set no_static, "Advanced: ignore the static analysis. The program will execute in an unsafe manner."
  ...
  ; "-mixed", Arg.Set mixed, "Use the mixed-state simulator."
  ]
;;
